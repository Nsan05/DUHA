...
MODEL_PATH = Path("data/models/gb_model_nighttime.joblib")
OUTPUT_DIR = Path("data/final/phase3b_outputs")
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
OUTPUT_PATH = OUTPUT_DIR / "lst_anomaly_nighttime_30m.tif"
...
def main():
    """
    Phase 3B: Nighttime Prediction
    
    Applies the VIIRS Nighttime-trained model at 30m resolution to produce
    a city-wide high-resolution LST anomaly map for the 1:30 AM slot.
    """
    ...
    logger.info("Phase 3B Nighttime Prediction Complete!")
